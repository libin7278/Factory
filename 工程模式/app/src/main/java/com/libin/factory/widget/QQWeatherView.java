...
public class QQWeatherView extends View {
    //模拟数据 start
    public static final String wees[]={"今天","星期二","星期三","星期四","星期五"};
    public static final String dayWeather[]={"晴天","小雨","小雨","中雨","小雨"};
    public static final int  dayRes[]={R.drawable.timg,R.drawable.timg,R.drawable.timg,R.drawable.timg,R.drawable.timg};
    public static final int dayTemp[]={23,22,23,20,17};
    public static final int nightTemp[]={18,17,18,12,11};
    public static final int  nightRes[]={R.drawable.timg,R.drawable.timg,R.drawable.timg,R.drawable.timg,R.drawable.timg};
    ...
    public QQWeatherView(Context context) {
        this(context,null);
    }

    public QQWeatherView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public QQWeatherView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void intPaint() {
        ...
        textPaint=new TextPaint(); //Paint是TextPaint的父类，TextPaint从名字来看是用来处理文字的。
